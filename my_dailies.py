                                                                ...
                                                                duration = "one week"
                                                                          number_people = 2
                                                                                    #I will now define below, the functionality of my class
                                                                                              def quality(self):
                                                                                                                print("must be exquisite", "by the lake", "there is room for a third guest", "weath
                                                                                                                      er must be great, else, notify guests", "must be within clients' budget", "must cater to in
                                                                                                                            dividualized needs of guests")
